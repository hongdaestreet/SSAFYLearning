...
public class DBUtil {
     ...
     * @throws SQLException
     */
    // (인터페이스) DriverManager를 통해 Connection을 생성하고 반환
     ...
     * ... 을 이용하므로 필요에 따라서 select 계열 호출 후는 ResultSet, Statement, Connection
    ...
    // 사용한 리소스들을 정리
    public void close(AutoCloseable... closeables) {  // ... -> 가변 인자 문법; 인자 수를 동적으로 할당할 수 있음
